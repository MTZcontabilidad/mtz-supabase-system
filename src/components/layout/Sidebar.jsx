...
const navigation = [
  { name: 'Dashboard MTZ', href: '/app/dashboard', icon: LayoutDashboard },
  { name: 'Clientes', href: '/app/clientes', icon: Users },
  {
    name: 'Portal Clientes',
    href: '/app/portal-clientes',
    icon: User,
    clienteOnly: true,
  },
  { name: 'Ventas', href: '/app/ventas', icon: FileText },
  { name: 'Cobranza', href: '/app/cobranza', icon: DollarSign },
  { name: 'Compras', href: '/app/compras', icon: Building },
  {
    name: 'Contratos',
    href: '/app/contratos',
    icon: FileText,
  ...
  { name: 'IVA', href: '/app/iva', icon: Calculator },
  { name: 'RRHH', href: '/app/rrhh', icon: Briefcase },
  { name: 'Carga Masiva', href: '/app/carga-masiva', icon: Upload },
  { name: 'Reportes', href: '/app/reportes', icon: FileText },
  {
    name: 'Administración',
