...
/**
 * Script para limpiar imports no utilizados en el proyecto MTZ
 * Elimina imports de React innecesarios y otros imports no utilizados
 */
...
function processFile(filePath) {
  try {
    ...
    // Eliminar import de React si solo se usa para JSX
